...
creator_mnemonic = os.getenv('CREATOR_PRIVATE_KEY')
user_mnemonic = os.getenv('USER_PRIVATE_KEY')
...
def create_asset(client, private_key, asset_total, asset_unit_NAME, asset_name):
...
def call_app(client, private_key, index, app_args):
    ...
    # call application
def call_app_with_assest(client, private_key, index, asset_id, app_args):
    # declare sender
    sender = account.address_from_private_key(private_key)
    print("Call from account:", sender)
    ...
    # create unsigned transaction
    txn = transaction.ApplicationCallTxn(params, index, app_args, foreign_assets=[asset_id])
